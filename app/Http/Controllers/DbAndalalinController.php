...
class DbAndalalinController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(DbAndalalin $admin){
        // $user = User::find($id);
        $title = 'Profile';
    ...
    public function update(Request $request, $id){
        ...
        DbAndalalin::where('id', $id)->update([
            'verifikasi' => $request->verifikasi,
        ]);

        return Redirect::route('admin.index')->with('message', 'Berhasil Verifikasi');
    }
